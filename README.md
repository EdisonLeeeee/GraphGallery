...
+ (2021/11/20) The module `attack` is deprecated, users may refer to [GraphWar]() for more information.
...
| **GMNN**                   | *Meng Qu et al*              | [Graph Attention Networks (ICLR'19)](https://arxiv.org/abs/1905.06214)                                                                                                    |                    |                    |                    |
...
| **DAGNN**                  | *Meng Liu et al*             | [Towards Deeper Graph Neural Networks (KDD'20)](https://arxiv.org/abs/2007.09296)                                                                                         | :heavy_check_mark: |                    |                    |
...
| **APPNP, PPNP**            | *Johannes Klicpera et al*    | [Predict then Propagate: Graph Neural Networks meet Personalized PageRank (ICLR'19)](https://arxiv.org/abs/1810.05997)                                                    | :heavy_check_mark: |                    |                    |
...
| **AGNN**                   | *Zhu et al*                  | [Attention-based Graph Neural Network for semi-supervised learning (ICLR'18 openreview)](https://arxiv.org/abs/1609.02907)                                                | :heavy_check_mark: |                    |                    |
