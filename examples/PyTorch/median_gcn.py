...
trainer = MedianGCN(device=device, seed=123).setup_graph(graph, attr_transform=None).build()
# trainer = TrimmedGCN(device=device, seed=123).setup_graph(graph, attr_transform=None).build()
