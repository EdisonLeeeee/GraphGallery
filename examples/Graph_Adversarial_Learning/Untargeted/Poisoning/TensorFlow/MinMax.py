...
################### Surrogate model ############################
trainer = gg.gallery.nodeclas.DenseGCN(graph, device=device, seed=123).process().build()
...
################### Attacker model ############################
attacker = gg.attack.untargeted.MinMax(graph, device=device, seed=123).process(
    trainer, splits.train_nodes, lr=5e-3)
...
perturbed prediction 77.41%
The accuracy has gone down 6.09%"""
